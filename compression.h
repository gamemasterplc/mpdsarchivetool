...
#define COMPRESSION_HUFFMAN_4        3
#define COMPRESSION_HUFFMAN_8        4
#define COMPRESSION_LZ77_HEADER      5
...
/******************************************************************************\
*
* Gets name for a compression type id.
*
* Parameters:
*	type					id of a compression type
*
* Returns:
*	A read-only pointer to the string describing the compression type.
*
\******************************************************************************/
...
/******************************************************************************\
*
* Gets id for a compression type name
*
* Parameters:
*	name					name of a compression type
*
* Returns:
*	The id of the compression type.
*
\******************************************************************************/
